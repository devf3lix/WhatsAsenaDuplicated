...
if (conf.WORKTYPE == 'private') {
    Asena.addCommand({pattern: 'yengec$', fromMe: true, desc: yengec}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'akrep$', fromMe: true, desc: akrep}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'koc$', fromMe: true, desc: koc}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'kova$', fromMe: true, desc: kova}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'oglak$', fromMe: true, desc: oglak}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'ikizler$', fromMe: true, desc: ikizler}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'yay$', fromMe: true, desc: yay}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'balık$', fromMe: true,desc: balık}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'terazi$', fromMe: true, desc: terazi}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'boga$', fromMe: true, desc: boga}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'aslan$', fromMe: true, desc: aslan}, (async (message, match) => {
